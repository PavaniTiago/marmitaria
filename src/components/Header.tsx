...
export function Header(){
    return (
        <header className="flex absolute w-full items-center backdrop-blur-xl justify-between px-12 lg:px-24 h-40">
            ...
            <div className="block lg:hidden">
                <Sheet>
                    ...
                    <SheetHeader className="lg:ml-4 mt-6 lg:pl-6 pt-6 space-y-0">
                        ...
                        <SheetDescription className="text-md text-black font-medium hover:bg-gray-200 transition-colors cursor-pointer"><Link href="#menu">Menu</Link></SheetDescription>
                        <SheetTitle className="text-lg text-foreground/60 pt-3">Contato</SheetTitle>
                        <SheetDescription className="text-md text-black font-medium hover:bg-gray-200 transition-colors cursor-pointer"><Link href="https://linktr.ee/saboraoponto_">Fale conosco</Link></SheetDescription>
                        <SheetTitle className="text-lg text-foreground/60 pt-3">Sobre</SheetTitle>
                        <SheetDescription className="text-md text-black font-medium hover:bg-gray-200 transition-colors cursor-pointer"><Link href="#sobre">Nossa nutricionista</Link></SheetDescription>
                    </SheetHeader>
                    <SheetFooter>
