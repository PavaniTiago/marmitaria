  ...
  return (
    <div className="relative flex flex-col items-center justify-center bg-white w-80 h-[34rem] rounded-xl rounded-tl-[4rem] rounde-br-[4rem] shadow-xl">
      <div className="absolute -top-20">
        {img && img2 && img3 ? (
          <div className="flex justify-center items-center">
            ...
            <Image
              ...
              width={0}
              height={0}
              className="object-contain absolute right-28 top-20 w-32 h-32"
            />
            <Image
              src={img3}
              alt="prato da marmitaria"
        ...
        {price && (
          <>
            <div className="flex items-center justify-center absolute rounded-full h-12 w-12 top-0 right-[39%] translate-y-[-50%] bg-primary text-white shadow-lg shadow-black/60">
      ...
      <span className="text-2xl font-bold absolute top-32 font-davidLibre">
        {title}
      </span>
      <div className="flex flex-col w-full absolute px-6 top-40">
        {optionalDescription && (
          <>
            <span className="text-lg font-semibold text-primary text-start">
              Opção 1
            </span>
        ...
        {opcao1 && (
          <>
            ...
            <div className="flex flex-col w-full h-full ml-6 mb-2">
              ...
              <span className="text-sm font-light text-[#5C6574] pr-8">
                {description1}
              </span>
            </div>
          </>
      ...
      {vegetable && (
        <>
          <div className="flex flex-col justify-end w-full pb-4 h-full ml-12 px-6">
            ...
            <li className="text-lg font-semibold text-start">
              Opções de salada
            </li>
            <span className="text-sm font-light text-[#5C6574]">
              {vegetable}
      ...
      <Link
        target="_blank"
        className="absolute -bottom-10 font-semibold text-md"
